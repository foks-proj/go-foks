...
type RTChannelMetadataInternal__ struct {
	...
	LastMsg             *RTMessageMetadataInternal__
...
func (r RTChannelMetadataInternal__) Import() RTChannelMetadata {
	return RTChannelMetadata{
		...
		LastMsg: (func(x *RTMessageMetadataInternal__) *RTMessageMetadata {
			if x == nil {
				return nil
			}
			tmp := (func(x *RTMessageMetadataInternal__) (ret RTMessageMetadata) {
				if x == nil {
					return ret
				}
				return x.Import()
...
func (r RTChannelMetadata) Export() *RTChannelMetadataInternal__ {
	return &RTChannelMetadataInternal__{
		...
		LastMsg: (func(x *RTMessageMetadata) *RTMessageMetadataInternal__ {
			if x == nil {
				return nil
			}
			return (*x).Export()
