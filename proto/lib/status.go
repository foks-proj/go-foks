...
const (
	...
	StatusCode_RT_CHANNEL_ARCHIVED_ERROR               StatusCode = 12010
)
...
var StatusCodeMap = map[string]StatusCode{
	...
	"RT_CHANNEL_ARCHIVED_ERROR":               12010,
}
var StatusCodeRevMap = map[StatusCode]string{
	...
	12010: "RT_CHANNEL_ARCHIVED_ERROR",
}
