...
const (
	...
	StatusCode_RT_CHANNEL_RACE                         StatusCode = 12003
)
...
func NewStatusWithRtChannelRace() Status {
	return Status{
		Sc: StatusCode_RT_CHANNEL_RACE,
	}
}
