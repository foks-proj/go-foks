...
**Open: generalizing this to all teams.** Re-seal-at-drain could extend beyond
ad-hoc teams, which would solve staleness at its root: a message sealed at drain, after a fresh
